...
def handle_callback(bot: TeleBot, call: CallbackQuery):
    ...
    """
    try:
        logger.info(f"Procesando callback: {call.data}")
        ...
        # El manejo de los callbacks de pago se delega al payment_handler
...
def register_callback_handlers(bot: TeleBot):
    ...
    Args:
        bot: Instancia del bot
    """
    logger.info("Registrando handler para callbacks")
